...
public class Controller {
    ...
    public Controller(WebClient webClient, ObjectMaker objectMaker) {
    ...
    public Object searchDoctors(@RequestBody String body) throws JsonProcessingException {
        ...
        String result = objectMaker
                .readBreadth(body, "doctors", "headers", "guided_prompt", "listing_data", "display_specialization")
                .toString();
        return Map.of("prime_header",
                ...
                objectMaker.readTree(result, "guided_prompt", "entities", "1", "title"), "doctors_found",
